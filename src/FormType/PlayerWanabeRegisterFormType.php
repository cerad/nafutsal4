...
class PlayerWanabeRegisterFormType extends AbstractType
{
    public function getName() { return 'cerad_player_wanabe_register'; }
   
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'App\Entity\PlayerWanabe',
            'error_bubbling' => true,
            'required'   => true,
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('state',  TextType::class, array('required' => false));
        ...
        $builder->add('phoneEmergencyContact',PhoneFormType::class,array('label' => "Emergency Contact's Phone", 'required' => false));
        ...
        $builder->add('volunteerism',TextType::class, array('attr' => array('size' => 50), 'required' => false));
        $builder->add('seasonDesired',ChoiceType::class,array(
            'label' => 'play',
            'multiple' => false,
            'expanded' => false,
            'required' => true,
            'choices' => array('Winter' => 'Winter', 'Summer' => 'Summer') 
        ));
    }
}
